...
export const store = new Vuex.Store({
    ...
    state: {
        ...
        formInputs: {
            phone_number:       {inputId: 'phone_number', placeHolder: 'Phone Number', display: true, type: 'number', max_length: '12', value: ''},
            email:              {inputId: 'email', placeHolder: 'Email', display: false, type: 'email', max_length: '50', value: ''},
            first_name:         {inputId: 'first_name', placeHolder: 'First Name', display: false, type: 'text', max_length: '30', value: ''},
            last_name:          {inputId: 'last_name', placeHolder: 'Last Name', display: false, type: 'text', max_length: '30', value: ''},
            password:           {inputId: 'password', placeHolder: 'Password', display: true, type: 'password', max_length: '20', value: ''},
            confirm_password:   {inputId: 'confirm_password', placeHolder: 'Enter Password Again', display: false, type: 'password', max_length: '20',  value: ''},
            one_time_token:     {inputId: 'one_time_token', placeHolder: 'Token', display: false, type: 'number', max_length: '6', value: ''},
        },
        buttons: {

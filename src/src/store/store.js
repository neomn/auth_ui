...
export const store = new Vuex.Store({
    state: {
        ...
        formInputs: {
            phone_number: {placeHolder: '', display: true, value: ''},
            email: {placeHolder: '', display: false, value: ''},
            first_name: {placeHolder: '', display: false, value: ''},
            last_name: {placeHolder: '', display: false, value: ''},
            password: {placeHolder: '', display: true, value: ''},
            confirm_password: {placeHolder: '', display: false, value: ''},
            one_time_token: {placeHolder: '', display: false, value: ''},
        },
        buttons: {

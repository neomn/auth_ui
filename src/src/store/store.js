...
export const store = new Vuex.Store({
    ...
    state: {
        ...
        formInputs: {
            phone_number:   {inputId: 'phone_number',    placeHolder: 'Phone Number',  display: true,  type: 'number',    value: '', valid:false, passedValidationRules:[], pendingValidationRules:[] },
            email:          {inputId: 'email',           placeHolder: 'Email',         display: false, type: 'email',     value: '', valid:false, passedValidationRules:[], pendingValidationRules:[] },
            first_name:     {inputId: 'first_name',      placeHolder: 'First Name',    display: false, type: 'text',      value: '', valid:false, passedValidationRules:[], pendingValidationRules:[] },
            last_name:      {inputId: 'last_name',       placeHolder: 'Last Name',     display: false, type: 'text',      value: '', valid:false, passedValidationRules:[], pendingValidationRules:[] },
            password:       {inputId: 'password',        placeHolder: 'Password',      display: true,  type: 'password',  value: '', valid:false, passedValidationRules:[], pendingValidationRules:[] },
            one_time_token: {inputId: 'one_time_token',  placeHolder: 'Token',         display: false, type: 'number',    value: '', valid:false, passedValidationRules:[], pendingValidationRules:[] },
        },
        buttons: {

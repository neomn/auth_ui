...
export const store = new Vuex.Store({
    state: {
        ...
        formInputs: {
            phone_number: {placeHolder: 'Phone Number', display: true, type: 'number', value: ''},
            email: {placeHolder: 'Email', display: false, type: 'email',  value: ''},
            first_name: {placeHolder: 'First Name', display: false, type: 'text', value: ''},
            last_name: {placeHolder: 'Last Name', display: false, type: 'text', value: ''},
            password: {placeHolder: 'Password', display: true, type: 'password', value: ''},
            confirm_password: {placeHolder: 'Enter Password Again', display: false, type: 'password', value: ''},
            one_time_token: {placeHolder: 'Token', display: false, type: 'number', value: ''},
        },
        buttons: {
